...
void UMP_LANMenu::NativeOnInitialized()
{
	...
	Button_Host->OnClicked.AddDynamic(this, &ThisClass::UMP_LANMenu::HostButtonClicked);
	Button_Join->OnClicked.AddDynamic(this, &ThisClass::UMP_LANMenu::JoinButtonClicked);
}
